...
DigitKeyWidget::DigitKeyWidget(int screen_width, int screen_height, QWidget *parent)
    : screen_width_(screen_width), screen_height_(screen_height), QWidget(parent) {

	setStyleSheet("QPushButton {border-image: url(:asserts/key_background.png);color:white;font-size:80px;padding-top:35px;}");

	QPushButton *ppb_btn = new QPushButton(this);
	setCommonAttribute(ppb_btn);
	ppb_btn->setStyleSheet("QPushButton {border-image: url(:asserts/back_small.png);margin:0px;}");
	...
	ple_input_tip_->setStyleSheet("QLineEdit {background-color:rgb(51, 51, 51);color:white;font-size:80px;padding-top:35px;}");
	...
	ppb_btn = new QPushButton(this);
	setCommonAttribute(ppb_btn);
	ppb_btn->setStyleSheet("QPushButton {border-image: url(:asserts/backspace.png);}");
	...
	ppb_doorbell_->setStyleSheet("QPushButton {border-image: url(:asserts/doorbell.png);}");
	...
	ppb_intercom_->setStyleSheet("QPushButton {border-image: url(:asserts/intercom_small.png);}");
	...
	ppb_video_->setStyleSheet("QPushButton {border-image: url(:asserts/video.png);}");
