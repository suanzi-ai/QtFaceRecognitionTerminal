...
void CameraReader::run() {
  ...
  ImagePackage image_package1(VPSS_CH_SIZES_BGR[0], VPSS_CH_SIZES_BGR[1], VPSS_CH_SIZES_NIR[0], VPSS_CH_SIZES_NIR[1]);
  ImagePackage image_package2(VPSS_CH_SIZES_BGR[0], VPSS_CH_SIZES_BGR[1], VPSS_CH_SIZES_NIR[0], VPSS_CH_SIZES_NIR[1]);
